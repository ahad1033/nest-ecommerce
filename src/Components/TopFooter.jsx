      ...
      <footer className="p-4 mt-11">
        <div className="grid grid-cols-3 gap-6 lg:gap-4 lg:grid-cols-6">
          ...
          <div className="col-span-1">
            <img className="w-28 lg:w-full" src="/Header.png" alt="" />
            <h1 className="text-black my-2 lg:my-5 text-sm lg:text-md">
              Awesome grocery store
            </h1>
            <p className="text-black font-secondary text-sm mb-4">Address: 101 Lalmatia, Dhaka 1208</p>
            <p className="text-black font-secondary text-sm mb-4">Call Us: (+91) - 540-025-124553</p>
            <p className="text-black font-secondary text-sm mb-4">Email: sale@Nest.com</p>
          ...
          <div className="col-span-1">
            ...
            <p className="text-black  font-secondary text-sm mb-4">Delivery Information</p>
            <p className="text-black  font-secondary text-sm mb-4">Privacy Pokicy</p>
            <p className="text-black  font-secondary text-sm mb-4">Terms & Condition</p>
            <p className="text-black  font-secondary text-sm mb-4">Contact Us</p>
          ...
          <div className="col-span-1">
            ...
            <p className="text-black  font-secondary text-sm mb-4">View Cart</p>
            <p className="text-black  font-secondary text-sm mb-4">My Wishlist</p>
            <p className="text-black  font-secondary text-sm mb-4">Track My Order</p>
            <p className="text-black  font-secondary text-sm mb-4">Help Ticket</p>
          ...
          <div className="col-span-1">
            ...
            <p className="text-black  font-secondary text-sm mb-4">Affiliate Program</p>
            <p className="text-black  font-secondary text-sm mb-4">Farm Business</p>
            <p className="text-black  font-secondary text-sm mb-4">Our Suppliers</p>
            <p className="text-black  font-secondary text-sm mb-4">Accesibility</p>
